...
int main(int argc, char const *argv[])
{
    ...
    printf("Example output for normal menu ====>%s|%s|%s|%s|%s\n", cafe.normal_menus[2].date, cafe.normal_menus[2].soup, cafe.normal_menus[2].main_dish, cafe.normal_menus[2].side_dish, cafe.normal_menus[2].extra);

    printf("Example output for vegan menu ====>%s|%s|%s|%s|%s\n", cafe.vegan_menus[7].date, cafe.vegan_menus[7].soup, cafe.vegan_menus[7].main_dish, cafe.vegan_menus[7].side_dish, cafe.vegan_menus[7].extra);

    printf("Example output for vegetarian menu ====>%s|%s|%s|%s|%s\n", cafe.vegetarian_menus[13].date, cafe.vegetarian_menus[13].soup, cafe.vegetarian_menus[13].main_dish, cafe.vegetarian_menus[13].side_dish, cafe.vegetarian_menus[13].extra);

    int dates[] = {2, 9, 19};
    printf("Counts for the example normal menu output of March %drd ====>", dates[0]+1);
    printf("%s%d, ", "Student:", cafe.normal_menus[dates[0]].sale_count[0]);
    printf("%s%d, ", "Academic:", cafe.normal_menus[dates[0]].sale_count[1]);
    printf("%s%d\n\n", "Administrative:", cafe.normal_menus[dates[0]].sale_count[2]);

    printf("Counts for the example vegan menu output of March %drd ====>", dates[1]+1);
    printf("%s%d, ", "Student:", cafe.normal_menus[dates[1]].sale_count[0]);
    printf("%s%d, ", "Academic:", cafe.normal_menus[dates[1]].sale_count[1]);
    printf("%s%d\n\n", "Administrative:", cafe.normal_menus[dates[1]].sale_count[2]);

    printf("Counts for the example vegetarian menu output of March %drd ====>", dates[0]+1);
    printf("%s%d, ", "Student:", cafe.normal_menus[dates[2]].sale_count[0]);
    printf("%s%d, ", "Academic:", cafe.normal_menus[dates[2]].sale_count[1]);
    printf("%s%d\n\n", "Administrative:", cafe.normal_menus[dates[2]].sale_count[2]);
...
void calc_and_show_income(cafeteria *cafe){
    ...
    printf("%s%d TL\n", "Total sale income: ", student_income + academic_income + administrative_income);
}
